    ...
    <form class="form form-horizontal" enctype='multipart/form-data' id="form-add-product">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				...
				<select name="cpId" id="cpId" class="select" onchange="showSonClass(this)">
...
<script>
    ...
    $(function () {
        ...
        $.ajax({
            ...
            url: "/admin/item2/parentClassAjax",
            dataType: "json",//必须
            async: false,
            success:
                function (data) {
    ...
    //显示子分类
    function showSonClass(obj) {
        var parentClass = $(obj).val();
        //alert(parentClass);
