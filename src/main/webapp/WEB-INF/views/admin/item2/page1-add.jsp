...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/admin/css/item2/page1-add.css"/>
    <title>新增商品</title>
    <link href="${ctx}/admin/h-ui/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<div class="page-container">
    <form class="form form-horizontal" enctype='multipart/form-data' id="form-add-product">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				...
				<select name="bcName" id="bcName" class="select">
					<%--<option value="0">餐饮</option>--%>
					<%--<option value="12">娱乐休闲</option>--%>
				</select>
				</span>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
				<select name="scName" class="select">
        ...
        <%--<div class="formControls col-xs-8 col-sm-9">--%>
        <%--<div class="radio-box">--%>
        <%--<input name="types" type="radio" checked>--%>
        <%--<label for="sex-1">线上</label>--%>
        <%--</div>--%>
        <%--<div class="radio-box">--%>
        <%--<input type="radio" name="types">--%>
        <%--<label for="sex-2">线下</label>--%>
        <%--</div>--%>
        <%--</div>--%>
        <%--</div>--%>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" class="input-text short-input prive-input" value="0" placeholder="" id="pPrice"
                       name="pPrice">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" class="input-text short-input prive-input" value="0" placeholder="" id="pIntegral"
                       name="pIntegral">
            </div>
        </div>
        ...
        <!--优惠积分-->
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">优惠积分：</label>
            <div class="formControls col-xs-8 col-sm-9">
				<span class="price">
					<i class="Hui-iconfont Hui-iconfont-jifen"></i>
				</span>
                <input type="text" class="input-text short-input prive-input" value="0" placeholder="优惠积分" id="pDiscounts"
                       name="pDiscounts">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="pIntro" cols="" rows="" class="textarea" placeholder="说点什么...最少输入10个字符" datatype="*10-100"
                          dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)" id="pIntro"></textarea>
        ...
        success:
            function (response) {
                if (response.errorCode == "200") {
                    //获取大分类的数据
                    for (var i = 0; i < response.item.bc.length; i++) {
                        $("#bcName").append("<option value='" + response.item.bc[i].cId + "'>" + response.item.bc[i].cName + "</option>");
                    }
                }
            }
...
//    //保存并提交审核
//    var article_save_submit = function () {
//
//        $.ajax({
//            type: "post",
//            url: "page1-add",
...
//            ,
//        })
//        $("#form-add-class").ajaxSubmit(article_save_submit);
//        return false;
////        }
//    }
...
<script type="text/javascript" src="${ctx}/admin/h-ui/lib/webuploader/0.1.5/webuploader.min.js"></script>
